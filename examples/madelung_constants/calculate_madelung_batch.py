...
if __name__ == "__main__":
    ...
    # Place the ghost atoms at random positions , as an easy way of ensuring
    # that (very likely) no two atoms are in the exact same position
    # (even if they were, it should not matter due to the way
    # msmjax.jax_md.smap._generalized_diagonal_mask works, but we still want
    # to avoid it):
