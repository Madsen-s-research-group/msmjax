        ...
        for p in LIST_OF_PS:
            ...
            for quantity in cmd_args.quantity:
                ...
                if onp.any(pbc):
                    ...
                    # replicas of the unit cell. The benefit of using a
                    # neighbor list would therefore be small at best.
                    # (There is some overhead to evaluation using a neighbor
                    # list, presumably due to non-contiguous access patterns)
